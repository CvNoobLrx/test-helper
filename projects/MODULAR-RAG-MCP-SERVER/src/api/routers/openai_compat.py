...
from src.api.routers.query import (
    QueryRequest,
    _stream_answer_chunks,
    retrieve_rag,
    run_rag_query,
)
    ...
    if req.stream:
        async def event_stream():
            ...
            try:
                ...
                retrieved = await retrieve_rag(rag_req)
                answer_meta: dict[str, Any] = {}
                for content in _stream_answer_chunks(
                    query,
                    retrieved["citations"],
                    retrieved["fallback"],
                    answer_meta,
                ...
                yield _sse_data({
                    **_chunk("", req.model, chunk_id=chunk_id, finish_reason="stop"),
                    ...
                    "metadata": {**retrieved.get("metadata", {}), **answer_meta},
                })
